<?php
class TrustindexPlugin_arukereso
{
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for Árukereső Reviews", "do-not-care-Árukereső");
